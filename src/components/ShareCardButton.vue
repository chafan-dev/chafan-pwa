  ...
  <span>
    <v-dialog v-model="showSharingCard" max-width="600">
      <v-card @click-outside="showSharingCard = false">
        <div class="pa-4">
          <div class="pb-2">
            <v-btn size="small" variant="tonal" @click="onClickCopy" class="mr-2">点击复制链接</v-btn>
    ...
    <v-btn variant="tonal" size="small" @click="showSharingCardDialog" class="slim-btn">
      <AppIcon name="Share" size="small"  />
